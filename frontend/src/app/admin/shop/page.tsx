...
export default function AdminShopPage() {
  ...
  return <Stack spacing={2}>
    <Stack direction={{ xs: "column", sm: "row" }} justifyContent="space-between" gap={2}><div><Typography variant="h4" fontWeight={900}>Shop & Deals</Typography><Typography color="text.secondary">Manual Shopee affiliate posts, rankings, guides, and flash deals.</Typography></div><Button component={Link} href="/admin/shop/new" variant="contained">New post</Button></Stack>
    <TextField size="small" label="Search posts" value={q} onChange={(e) => setQ(e.target.value)} sx={{ maxWidth: 420 }} />
