...
urlpatterns = [
    ...
    path("discovery/runs/", api.discovery_run_list, name="discovery-run-list"),
    path("discovery/runs/queue/", api.discovery_run_create, name="discovery-run-create"),
    path("discovery/runs/<int:run_id>/", api.discovery_run_detail, name="discovery-run-detail"),
